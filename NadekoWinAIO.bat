...
bitsadmin.exe /transfer "Downloading Nadeko (Latest)" /priority high https://github.com/samdivaio/NadekoBotInstallerWin/raw/master/NadekoInstallerLatest.bat "%FILENAME%"
...
bitsadmin.exe /transfer "Downloading Nadeko (Stable)" /priority high https://github.com/samdivaio/NadekoBotInstallerWin/raw/master/NadekoInstaller.bat "%FILENAME%"
...
bitsadmin.exe /transfer "Downloading Nadeko Run (normal)" /priority high https://github.com/samdivaio/NadekoBotInstallerWin/raw/master/NadekoRun.bat "%FILENAME%"
ECHO.
...
bitsadmin.exe /transfer "Downloading Nadeko Auto-Run" /priority high https://github.com/samdivaio/NadekoBotInstallerWin/raw/master/NadekoAutoRun.bat "%FILENAME%"
ECHO.
